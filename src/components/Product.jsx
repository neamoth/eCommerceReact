...
function Product({ item }) {
  ...
  const iconStyle = 'h-[2.5em] w-[2.5em] rounded-full bg-white flex items-center justify-center m-3 hover:bg-[#894af3] hover:text-white hover:scale-[1.1] ease-in duration-100 cursor-pointer'
