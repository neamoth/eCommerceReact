  ...
  return (
    <div className='parentDiv items-center justify-between'>
      ...
      <div className={arrowStyle} >
        <ArrowLeftOutlined style={{ fontSize: '3.125em' }} onClick={preSlide} />
      </div>
      {/* slideshow div */}
      {slides.map((slide, index) => {
        if (index === activeSlide) {
          return (
            <div className={`wrapper flex w-full h-106 justify-center items-center shadow-2xl rounded-lg border-white border-10px overflow-hidden relative` + slide.background}>
